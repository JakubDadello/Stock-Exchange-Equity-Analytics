...
function predict() {
    return __awaiter(this, void 0, void 0, function () {
        var values, res, results, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    values = [
                        Number(document.getElementById("net_income").value),
                        Number(document.getElementById("net_cash_flow").value),
                        Number(document.getElementById("roe").value),
                        Number(document.getElementById("roa").value),
                        Number(document.getElementById("ebitda").value),
                        Number(document.getElementById("cumulation").value),
                        String(document.getElementById("sector").value),
                    ];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("https://wbm2hiawv9.execute-api.eu-north-1.amazonaws.com/development/prediction", {
                            method: "POST",
